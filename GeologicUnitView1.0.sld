...
<StyledLayerDescriptor xmlns:xlink='http://www.w3.org/1999/xlink' 
	...
	<NamedLayer>
		...
		<UserStyle>
			...
			<Abstract>Styled for use in the OneGeology GeoSciML-Portrayal Geologic Unit View layer, 
				this assumes that the data implements the GeologicUnitType201202  
				URIs in the representativeAge_uri field. URIs are outlined in the content model 
				...
				(http://www.stratigraphy.org/index.php/ics-chart-timescale).</Abstract>
			<FeatureTypeStyle>
				<Rule>
